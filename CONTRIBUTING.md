...
For more information on contributing to illa-builder-frontend check out our [Build All-In-One-Image Dockerfile](https://github.com/khulnasoft/build-all-in-one-image/blob/main/dockerfile).
