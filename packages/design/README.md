...
<div align="center">
  <p>Create with ❤︎ by <a href="https://github.com/khulnasoft/devops/packages/design/graphs/contributors">contributors</a></p>
</div>
...
```bash
$ git clone https://github.com/khulnasoft/devops/packages/design.git
$ cd illa-design
$ pnpm install
```
